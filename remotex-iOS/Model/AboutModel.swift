...
struct AboutModel {
    ...
    init() {
        ...
        self.description = "RemoteX 远程工作空间是一个开发远程／众包／外包的信息聚合平台，我们将需求从不同的平台汇集到这里，非盈利组织运作。\n欢迎需求方／开发方联系我们。"
